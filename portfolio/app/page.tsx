    ...
    <main>
        ...
        <div className="relative mx-auto grid w-full max-w-6xl grid-cols-1 items-center gap-12 lg:grid-cols-[1.3fr_0.7fr]">
          ...
          >
            ...
            <p className="mt-6 max-w-lg text-sm leading-relaxed text-muted sm:text-base">
              Hi, I&apos;m Nethmi, from Sri Lanka with a passion for turning complex data
              into clear, practical insights. I work across Python, SQL, Power BI, Excel
              and Machine Learning models. Take a look at my projects below.
            </p>
      ...
      <footer className="border-t border-line px-6 py-10 text-center">
        <p className="font-mono text-xs uppercase tracking-widest text-muted">
          Nethmi Malsha — Built with Next.js &amp; Three.js
        </p>
      </footer>
